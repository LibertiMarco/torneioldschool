...
$canAccess = user_can_access_feature($conn, $userId, $userRole, 'totocalcio');
...
$seo = [
    'title' => 'Totocalcio',
    'description' => 'Area riservata Totocalcio.',
...
<main class="feature-page">
  <section class="feature-card">
    ...
    <h1>Totocalcio</h1>
    <?php if ($canAccess): ?>
      <p>Questa area e visibile solo agli account con il flag Totocalcio attivo e agli amministratori.</p>
      <p>La struttura di accesso e menu e pronta. Qui puoi poi inserire la logica reale del Totocalcio.</p>
