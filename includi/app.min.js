...
;(function(){document.addEventListener('click',function(e){var b=e.target.closest('#mobileMenuBtn');if(!b)return;var h=b.closest('.site-header');var n=h?h.querySelector('#mainNav'):null;var u=h?h.querySelector('#userMenu'):null;if(n){e.preventDefault();e.stopPropagation();var o=n.classList.toggle('open');if(o&&u){u.classList.remove('open');}}});document.addEventListener('click',function(e){var b=e.target.closest('#userBtn');if(!b)return;var h=b.closest('.site-header');var m=h?h.querySelector('#userMenu'):null;var n=h?h.querySelector('#mainNav'):null;if(m){e.preventDefault();e.stopPropagation();var o=m.classList.toggle('open');if(o&&n){n.classList.remove('open');}}});document.addEventListener('click',function(e){if(e.target.closest('.site-header'))return;document.querySelectorAll('.site-header .header-nav.open').forEach(function(nav){nav.classList.remove('open');});document.querySelectorAll('.site-header .user-menu.open').forEach(function(menu){menu.classList.remove('open');});});if(typeof window.initHeaderInteractions!=='function'){window.initHeaderInteractions=function(root){root=root&&root.querySelectorAll?root:document;root.querySelectorAll('.site-header');};}})();
