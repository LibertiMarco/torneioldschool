...
<body>
        ...
        <div class="admin-card-block">
          ...
          <form method="POST" id="formModifica" class="admin-form">
            ...
            <select name="torneo" id="edit_torneo" required>
              <option value="">-- Seleziona torneo --</option>
              <?php
                $torneiMod = $torneoRepo->getAll();
                while ($t = $torneiMod->fetch_assoc()):
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      faseGroups.forEach(cfg => {
        cfg.fase?.addEventListener('change', () => gestisciFase(cfg));
        gestisciFase(cfg);
      });
      ...
      const editForm = document.getElementById('formModifica');
