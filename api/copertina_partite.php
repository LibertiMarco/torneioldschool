...
(async()=>{brand=await loadImage('/img/logo_old_school.png');if(isIOS){$('downloadReel').textContent='Salva immagine';$('downloadYoutube').textContent='Salva immagine'}tournaments();draw()})();
