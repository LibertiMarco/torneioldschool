...
function tournamentImageBox(ctx,x,y,size){ctx.fillStyle='#fff';ctx.beginPath();ctx.roundRect(x,y,size,size,size*.04);ctx.fill();contain(ctx,tournamentLogo||brand,x+size*.08,y+size*.08,size*.84,size*.84)}
