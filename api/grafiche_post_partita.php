...
function drawFulltime(){const family=prepareTheme($('ftTournament').value,currentMatch());if(family==='editorial')return drawFulltimeEditorial();if(family==='cinematic')return drawFulltimeCinematic();return drawFulltimeDynamic();}
function drawMvp(){const family=prepareTheme($('mvpTournament').value,currentMatch());if(family==='editorial')return drawMvpEditorial();if(family==='cinematic')return drawMvpCinematic();return drawMvpDynamic();}
