...
<head>
  ...
  <title>Gestione Fantacalcio</title>
...
<body class="admin-page">
  ...
  <main class="admin-wrapper">
    ...
    <h1 class="admin-title">Gestione Fantacalcio</h1>
    <p style="margin: 0 0 20px; color: #475569;">Area admin pronta per sviluppare il Fantacalcio insieme nei prossimi passaggi.</p>

    <section class="work-grid">
      <article class="work-card">
        <span class="tag">Stato</span>
        <h3>Modulo inizializzato</h3>
        <p>La sezione admin e pronta e collegata alla dashboard. Qui potremo aggiungere regolamento, rose, giornate e calcolo punteggi.</p>
      </article>
      ...
      <article class="work-card">
        ...
        <ul class="todo-list">
          <li>Creazione squadre fantasy e composizione rose</li>
          <li>Calendario leghe e giornate</li>
          <li>Inserimento formazioni e panchine</li>
          <li>Calcolo voti, bonus, malus e classifica</li>
        </ul>
      </article>
      ...
      <article class="work-card">
        ...
        <h3>Base pronta</h3>
        <p>Quando vuoi possiamo partire dal database del Fantacalcio o dalla prima interfaccia di amministrazione.</p>
      </article>
    </section>
  </main>
