...
<body>
  ...
  <main class="content policy-page">
    ...
    <section class="policy-block">
      ...
      <ul>
        <li>Cookie di sessione (es. PHPSESSID) per login e funzionalita di base.</li>
        ...
        <li>reCAPTCHA di Google per proteggere i form (login, registrazione, contatti): Google puo impostare cookie e tracciare l'IP per rilevare abusi. Vedi la <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer">Privacy Policy di Google</a> e i <a href="https://policies.google.com/terms" target="_blank" rel="noreferrer">Termini di servizio</a>.</li>
      </ul>
    </section>
    ...
    <section class="policy-block">
      ...
      <ul>
        ...
        <li>Puoi anche cancellare i cookie dalle impostazioni del browser; questo fara riapparire il banner.</li>
      </ul>
    </section>
