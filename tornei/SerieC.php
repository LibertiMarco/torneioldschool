...
<meta charset="UTF-8" />
  ...
  <title>Serie C 3.0 - Tornei Old School</title>
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo Serie C 3.0">
      <div class="torneo-title">
        <h1 class="titolo">Serie C 3.0</h1>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    <div class="regola">
      ...
      <p>
        Il torneo ÃƒÂ¨ composto da <strong>12 squadre</strong> e si sviluppa in <strong>due fasi principali</strong>.
      </p>
    </div>

    <div class="regola">
      <h3>Ã¢Å¡Â½ Fase 1 Ã¢â‚¬â€ Regular Season</h3>
      <p>
    ...
    <div class="regola">
      <h3>Ã°Å¸Ââ€  Fase 2 Ã¢â‚¬â€ Coppe</h3>
      <ul>
    ...
    <div class="regola">
      ...
      <p>
        Il <strong>Miglior Giocatore</strong> vincerÃƒÂ  un
  ...
  <!-- SCRIPT: SERIE C -->
  <script src="script-SerieC.js?v=<?= $assetVersion ?>"></script>
