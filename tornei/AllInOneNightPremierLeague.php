...
$torneoSeo = [
  'title' => "All In One Night: Premier League - Tornei Old School",
  'description' => "All In One Night: Premier League: gironi, semifinali e finale in una sola serata. Calendario, classifiche, marcatori e rose aggiornate.",
  'url' => $baseUrl . '/tornei/AllInOneNightPremierLeague.php',
  'canonical' => $baseUrl . '/tornei/AllInOneNightPremierLeague.php',
  'type' => 'article',
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo All In One Night: Premier League">
      <div class="torneo-title">
        <h1 class="titolo">All In One Night: Premier League</h1>
      ...
      <div class="filtro-giornata">
        <div class="filtro-riga">
          ...
          <select id="faseCalendario">
            ...
            <option value="GOLD">Fase Finale</option>
          </select>
        </div>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    ...
    <div class="regola">
      ...
      <p>Vince la All In One Night: Premier League la squadra che si impone in finale.</p>
    </div>
...
<!-- MARCATORI -->
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-AllInOneNightPremierLeague.js?v=<?= $assetVersion ?>"></script>
