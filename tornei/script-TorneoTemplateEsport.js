// TEMPLATE BASE ESPORT: duplica e rinomina questo file per un nuovo torneo esport.
...
const TORNEO_META = window.__TORNEO_META__ || {};
const IS_ESPORT_TORNEO = String(TORNEO_META.sezione || "").trim().toLowerCase() === "esport";
