...
<meta charset="UTF-8" />
  ...
  <title>Primera Division 3.0 - Tornei Old School</title>
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo Primera Division 3.0">
      <div class="torneo-title">
        <h1 class="titolo">Primera Division 3.0</h1>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    ...
    <div class="regola">
      ...
      <p>
        Tutte le squadre disputano una <strong>Regular Season</strong> in stile Champions League per un totale di
        <strong>8 partite</strong> ciascuna.
      </p>
      <p>
        La prima classificata al termine del girone riceve il
    ...
    <div class="regola">
      ...
      <ul>
        <li>Durata partita: <strong>2 tempi da 25 minuti</strong>.</li>
        <li><strong>1 chiamata VAR</strong> disponibile per squadra in ogni gara.</li>
      </ul>
    </div>
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-PrimeraDivision.js?v=<?= $assetVersion ?>"></script>
