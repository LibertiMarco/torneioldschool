...
$torneoSeo = [
  ...
  'description' => "All in one night: Mondiale: gironi, semifinali e finale in una sola serata. Calendario, classifiche, marcatori e rose aggiornate.",
  'url' => $baseUrl . '/tornei/AllInOneNightMondiale.php',
  'canonical' => $baseUrl . '/tornei/AllInOneNightMondiale.php',
  'type' => 'article',
...
<!-- MARCATORI -->
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-AllInOneNightMondiale.js?v=<?= $assetVersion ?>"></script>
