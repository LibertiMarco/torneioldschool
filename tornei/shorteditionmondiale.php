...
<meta charset="UTF-8" />
  ...
  <title>Short edition: Mondiale 3.0 - Tornei Old School</title>
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo Short edition: Mondiale 3.0">
      <div class="torneo-title">
        <h1 class="titolo">Short edition: Mondiale 3.0</h1>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    ...
    <div class="regola">
      ...
      <p>
        Le <strong>16 squadre</strong> partecipano a una <strong>Regular Season</strong> di
        <strong>3 giornate</strong>.
      </p>
      <p>
    ...
    <div class="regola">
      <h3>Calendario</h3>
      <ul>
        <li>Le partite si disputano principalmente <strong>il mercoledi e il giovedi</strong>.</li>
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-shorteditionmondiale.js?v=<?= $assetVersion ?>"></script>
