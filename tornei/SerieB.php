...
<meta charset="UTF-8" />
  ...
  <title>Serie B 3.0 - Tornei Old School</title>
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo Serie B 3.0">
      <div class="torneo-title">
        <h1 class="titolo">Serie B 3.0</h1>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    ...
    <div class="regola">
      ...
      <ul>
        <li>Le partite si disputano principalmente <strong>il mercoledÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¬ e il giovedÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¬</strong>.</li>
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-SerieB.js?v=<?= $assetVersion ?>"></script>
