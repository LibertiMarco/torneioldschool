...
// 3) Duplica anche script-LegaIntercontinental.js rinominandolo in script-NuovoTorneo.js
...
$torneoSlug = 'LegaIntercontinental';
$torneoName = 'Lega Intercontinental';
...
$qualificatiSilver = array_key_exists('qualificati_silver', $torneoConfig)
    ...
    : null;
$qualificatiBronzo = array_key_exists('qualificati_bronzo', $torneoConfig)
    ? max(0, (int)$torneoConfig['qualificati_bronzo'])
    : null;
$showGoldCup = $qualificatiGold === null ? true : $qualificatiGold > 0;
$showSilverCup = $qualificatiSilver === null ? true : $qualificatiSilver > 0;
$showBronzeCup = $qualificatiBronzo === null ? false : $qualificatiBronzo > 0;
...
<!-- CLASSIFICA -->
  ...
  <script src="script-LegaIntercontinental.js?v=<?= $assetVersion ?>"></script>
