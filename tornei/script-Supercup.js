...
const GOLD_SEMI_SPOTS = 2;          // prime 2 vanno in semifinale Gold
const GOLD_QUARTI_SPOTS = 4;        // 3a-6a ai quarti Gold
const TEAM_COUNT = 10;              // totale squadre in regular
const SILVER_SPOTS = 4;             // 7a-10a in Silver (semifinali/finale)
const teamLogos = {};
...
async function caricaClassifica(torneoSlug = TORNEO) {
  try {
    ...
    const groupedSetup = gironiHelper?.renderGroupedClassifica({
      ...
      resolveLogoPath,
      fallbackGoldSpots: GOLD_SEMI_SPOTS + GOLD_QUARTI_SPOTS,
