...
$torneoSeo = [
  'title' => "All In One Night: Mondiale 2.0 - Tornei Old School",
  'description' => "All In One Night: Mondiale 2.0: gironi, semifinali e finale in una sola serata. Calendario, classifiche, marcatori e rose aggiornate.",
  'url' => $baseUrl . '/tornei/AllInOneNightMondiale2.php',
  'canonical' => $baseUrl . '/tornei/AllInOneNightMondiale2.php',
  'type' => 'article',
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo All In One Night: Mondiale 2.0">
      <div class="torneo-title">
        <h1 class="titolo">All In One Night: Mondiale 2.0</h1>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    ...
    <div class="regola">
      ...
      <p>Vince la All In One Night: Mondiale 2.0 la squadra che si impone in finale.</p>
    </div>
...
<!-- MARCATORI -->
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-AllInOneNightMondiale2.js?v=<?= $assetVersion ?>"></script>
