...
$torneoSeo = [
  'title' => "ALL IN ONE NIGHT: SERIE A - Tornei Old School",
  'description' => "ALL IN ONE NIGHT: SERIE A: gironi, semifinali e finale in una sola serata. Calendario, classifiche, marcatori e rose aggiornate.",
  'url' => $baseUrl . '/tornei/AllInOneNightSerieA.php',
  'canonical' => $baseUrl . '/tornei/AllInOneNightSerieA.php',
  'type' => 'article',
...
<body>
  ...
  <main class="content">
    <div class="torneo-hero">
      <img id="torneoHeroImg" src="/img/tornei/pallone.png" alt="Logo ALL IN ONE NIGHT: SERIE A">
      <div class="torneo-title">
        <h1 class="titolo">ALL IN ONE NIGHT: SERIE A</h1>
...
<section id="regole" class="tab-section">
  ...
  <div class="regole-box">
    ...
    <div class="regola">
      ...
      <p>Vince la ALL IN ONE NIGHT: SERIE A la squadra che si impone in finale.</p>
    </div>
...
<!-- MARCATORI -->
  ...
  <!-- SCRIPT: SERIE A -->
  <script src="script-AllInOneNightSerieA.js?v=<?= $assetVersion ?>"></script>
