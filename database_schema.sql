...
CREATE TABLE IF NOT EXISTS albo (
    ...
    giornata_unica TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS partite (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    torneo VARCHAR(255) NOT NULL,
    fase ENUM('REGULAR','SPAREGGIO','GOLD','SILVER','BRONZO') NOT NULL DEFAULT 'REGULAR',
    fase_round ENUM('TRENTADUESIMI','SEDICESIMI','OTTAVI','QUARTI','SEMIFINALE','FINALE') DEFAULT NULL,
    ...
    decisa_rigori TINYINT(1) NOT NULL DEFAULT 0,
    rigori_casa INT DEFAULT NULL,
    rigori_ospite INT DEFAULT NULL,
...
-- Consensi anonimi (per visitatori non autenticati, prova di consenso)
CREATE TABLE IF NOT EXISTS consensi_anonimi (
...
CREATE TABLE IF NOT EXISTS password_reset_tokens (
    ...
    CONSTRAINT fk_reset_user FOREIGN KEY (user_id) REFERENCES utenti(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
